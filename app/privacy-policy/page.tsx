...
import { Clock, Eye, FileText, Globe, Lock, Mail, Shield, Users } from 'lucide-react';
...
export default function PrivacyPolicyPage() {
  return (
    <div className='min-h-screen bg-black'>
      <Head>
        <title>Privacy Policy | FIELDPORTER</title>
        <meta
          name='description'
          content="FIELDPORTER's comprehensive privacy policy covering AI consulting services, data collection, and enterprise client data protection standards."
        />
        <meta property='og:title' content='Privacy Policy | FIELDPORTER' />
        <meta
          property='og:description'
          content='Learn how FIELDPORTER protects your data and privacy in our AI consulting services.'
        />
        ...
        <div className='container-fieldporter'>
          ...
          >
            <div className='flex items-center space-x-3 mb-6'>
              ...
              <span className='text-fieldporter-blue font-medium'>Privacy & Data Protection</span>
            </div>
            <h1 className='text-4xl lg:text-6xl font-bold text-white mb-6 leading-tight'>
              Privacy Policy
            </h1>
            <p className='text-xl text-fieldporter-gray leading-relaxed mb-8'>
              FIELDPORTER is committed to protecting your privacy and maintaining enterprise-grade
              data security standards. This policy explains how we collect, use, and protect your
              information in our AI consulting services.
            </p>
          ...
          >
            <div className='p-8 rounded-lg glass-dark border border-white/10'>
              ...
              <p className='text-fieldporter-gray mb-6 leading-relaxed'>
                ...
                will respond to all privacy inquiries within 5 business days.
              </p>
              <div className='flex flex-col sm:flex-row gap-4'>
                <Link
