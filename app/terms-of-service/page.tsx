          ...
          >
            <div className="p-8 rounded-lg glass-dark border border-white/10">
              ...
              <p className="text-fieldporter-gray mb-6 leading-relaxed">
                These terms are designed to protect both parties while fostering
                successful collaborative partnerships. We believe in
                transparency, professionalism, and delivering measurable value
                through our AI consulting services.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/contact"
