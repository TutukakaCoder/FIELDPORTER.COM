  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-fieldporter-black p-4'>
      <motion.div
        ...
        initial='initial'
        animate='animate'
        className='bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-glass max-w-md w-full'
      >
        <div className='text-center'>
          <motion.div variants={animations.premiumFadeInUp} className='mb-6'>
            ...
            <h1 className='text-heading-xl font-semibold text-white mb-3'>Something went wrong</h1>
