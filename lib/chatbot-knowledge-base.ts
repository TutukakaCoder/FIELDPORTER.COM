export const FIELDPORTER_KNOWLEDGE = {
  company: {
    ...
    positioning:
      "Strategic research and rapid prototyping for ambitious founders",
    business_model: "Consulting while building portfolio businesses",
    philosophy:
      "Building portfolio businesses while using consulting to fund development",
  },
