  ...
  [792],
  {
    ...
    5711: (e, t, r) => {
      ...
      let n = r(7677),
        ...
        s = RegExp('(at ' + i + ' )|(' + i + '\\@)'),
        u = a.default.captureOwnerStack ? a.default.captureOwnerStack : () => '';
      function l(e) {
        ...
        !(function t() {
          ...
          ((n = new window.WebSocket('' + u + e.path)).onopen = function () {
            ...
            (n.onmessage = function (e) {
              ...
              if ('action' in t && t.action === a.HMR_ACTIONS_SENT_TO_BROWSER.TURBOPACK_CONNECTED) {
    ...
    9402: (e, t, r) => {
      ...
      class V extends g.default.Component {
        ...
        componentDidMount() {
          this.scrollToHash(),
            n.isSsr &&
              (a.isFallback ||
                (a.nextExport && ((0, S.isDynamicRoute)(n.pathname) || location.search || q)) ||
      ...
      function K(e) {
        ...
        return (0, m.jsx)(V, {
          fn: e => Q({ App: d, err: e }).catch(e => console.error('Error rendering page: ', e)),
            ...
            .then(r => {
              ...
              let { ErrorComponent: u, styleSheets: l } = r,
                ...
                d = {
                  ...
                  AppTree: c,
                  router: n,
                  ctx: { err: s, pathname: a.page, query: a.query, asPath: o, AppTree: c },
                };
        ...
        return (
          !(function (e, t) {
            ...
            et
              ...
              : ((et = P.default.hydrateRoot(e, r, { onRecoverableError: k.onRecoverableError })),
                (er = !1));
      ...
      async function el(e) {
        ...
        let r = { App: d, initial: !0, Component: p, props: a.props, err: t, isHydratePass: !0 };
      ...
      class z {
            ...
            if (!this._bfl_s && !this._bfl_d) {
              ...
              (null == t ? void 0 : t.numHashes) &&
                ...
                (null == o ? void 0 : o.numHashes) &&
                  ((this._bfl_d = new s(o.numItems, o.errorRate)), this._bfl_d.import(o));
            }
            let c = !1,
              d = !1;
        ...
        async change(e, t, r, n, a) {
          ...
          try {
            ...
            if (
              (B ||
                n.shallow ||
                (await this._bfl(r, 'resolvedAs' in o ? o.resolvedAs : void 0, G.locale)),
              'route' in o && es)
            ) {
              ...
              if (
                ...
                let e =
                  !Q.shallow && o.resolvedAs
                    ? o.resolvedAs
                    : (0, v.addBasePath)(
                        (0, y.addLocale)(new URL(r, location.href).pathname, G.locale),
                        !0
                      );
            ...
            if ('type' in o) {
              ...
              return q({ url: o.destination, router: this }), new Promise(() => {});
            }
            let i = o.Component;
            if (
              (i &&
            ...
            let l = n.shallow && G.route === (null != (O = o.route) ? O : ea),
              ...
              P = { ...G, route: ea, pathname: et, query: er, asPath: J, isFallback: !1 };
            if (B && el) {
              if (
                ((o = await this.getRouteInfo({
                  route: this.pathname,
            ...
            if (
              ...
              !(B && !g && !X && !Z && (0, A.compareRouterStates)(P, this.state)))
            ) {
              try {
                await this.set(P, o, g);
              } catch (e) {
              ...
              if (o.error) throw (B || z.events.emit('routeChangeError', o.error, J, Q), o.error);
        ...
        async handleRouteInfoError(e, t, r, n, a, o) {
          ...
          if ((0, i.isAssetError)(e) || o)
            throw (z.events.emit('routeChangeError', e, n, a), q({ url: n, router: this }), L());
          console.error(e);
          try {
            let n;
        ...
        async getRouteInfo(e) {
          ...
          try {
            ...
            if (
              ...
              h &&
                (T
                  ...
                  : (T = { json: self.__NEXT_DATA__.props })),
              t(),
              (null == T ? void 0 : null == (y = T.effect) ? void 0 : y.type) ===
                'redirect-internal' ||
            ...
            if ((0, O.isAPIRoute)(P)) return q({ url: a, router: this }), new Promise(() => {});
            let j =
                u ||
