...
#### **1. `components/homepage/hero-3d-background.tsx`** _(New)_
...
#### **2. `components/ui/3d-section-background.tsx`** _(New)_
...
#### **3. `components/homepage/hero-section.tsx`** _(Modified)_
...
#### **4. `components/homepage/services-section.tsx`** _(Modified)_
...
const SectionBackground3D = dynamic(
  () =>
    import("../ui/3d-section-background").then((mod) => ({
      default: mod.SectionBackground3D,
    })),
  { ssr: false },
);
```
