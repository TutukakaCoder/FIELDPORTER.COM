    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="relative p-12 md:p-16 lg:p-20 rounded-3xl backdrop-blur-xl border border-white/10 bg-white/[0.02] hover:bg-white/[0.025] transition-all duration-500"
        >
