  ...
  return (
    <section className="relative py-16 sm:py-20 md:py-24 overflow-hidden">
      ...
      >
        ...
        <div className="relative">{/* Container for metrics content */}
            ...
            {indicators.map((indicator, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <motion.div 
                    className={`font-semibold text-white mb-2 ${isMobile ? 'text-xl' : 'text-lg lg:text-xl'}`}
                  ...
                  <motion.div 
                    className={`text-gray-300 font-light leading-relaxed transition-colors duration-300 group-hover:text-gray-200 ${isMobile ? 'text-sm' : 'text-xs lg:text-sm'}`}
                    initial={{ opacity: 0.8 }}
        ...
        <motion.div 
          className="w-full h-px bg-gradient-to-r from-transparent via-white/5 to-transparent mt-12"
          initial={{ scaleX: 0 }}
          whileInView={{ scaleX: 1 }}
          viewport={{ once: true }}
