  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (typeof window !== "undefined" && (window as any).gtag) {
        (window as any).gtag("event", ANALYTICS_EVENTS.consultationRequest, {
  ...
  if (isSubmitted) {
    return (
      <section
        ...
        className="py-24 bg-bg-fieldporter-secondary"
      >
            ...
            <Card className="bg-white/5 border-white/10 backdrop-blur-sm">
              <CardContent className="p-12">
                ...
                <p className="text-fieldporter-gray mb-6">
                  Thank you for your interest in FIELDPORTER&apos;s strategic AI
                  consulting. Our team will review your submission and contact
                  you within 24 hours to schedule your consultation.
                </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-fieldporter-gray text-lg">
              Complete this form to schedule your personalized AI transformation
              consultation
            </p>
          </div>
          ...
          <Card className="bg-white/5 border-white/10 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription className="text-fieldporter-gray">
                {currentStep === 1 &&
                  "Let us know how to reach you and your role"}
                {currentStep === 2 &&
                  "Help us understand your company and current challenges"}
                {currentStep === 3 &&
                  "Define your consultation objectives and requirements"}
                {currentStep === 4 &&
                  "Choose your preferred consultation format and timing"}
              </CardDescription>
            </CardHeader>
            <CardContent className="p-4 sm:p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        updateFormData("businessChallenge", e.target.value)
                      }
                  ...
                  <div>
                    <Label className="text-fieldporter-white">
                      Current AI/Automation Status *
                    </Label>
                    <Select
                      value={formData.aiStatus}
                      onValueChange={(value) =>
                        updateFormData("aiStatus", value)
                      }
                    >
                      <SelectTrigger className="mt-2">
                  ...
                  <div>
                    <Label
                      ...
                      className="text-fieldporter-white"
                    >
                      What would successful automation look like for your
                      business? *
                    </Label>
                    <Textarea
                      id="successVision"
                      ...
                      onChange={(e) =>
                        updateFormData("successVision", e.target.value)
                      }
              ...
              {currentStep === 3 && (
                <div className="space-y-6">
                  <div>
                    <Label className="text-fieldporter-white mb-4 block">
                      Service Interests *
                    </Label>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      {[
                        ...
                        >
                          <Checkbox
                            id={service}
                            checked={formData.serviceInterests.includes(
                              service,
                            )}
                          ...
                          <Label
                            htmlFor={service}
                            className="text-fieldporter-white text-sm"
                          >
                            {service}
                          </Label>
                        </div>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        updateFormData("techComfort", value)
                      }
                    >
                      <SelectTrigger className="mt-2">
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="expert">
                          Expert - Leading-edge technical team
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          updateFormData("consultationFormat", value)
                        }
                      >
                        <SelectTrigger className="mt-2">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateFormData("stakeholders", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        updateFormData("preparationMaterials", e.target.value)
                      }
